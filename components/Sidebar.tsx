...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const navItems: { label: string; view: ViewState; icon: string; adminOnly?: boolean }[] = [
    ...
    { label: 'Vehicles', view: 'VehicleList', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', adminOnly: true },
    { label: 'History', view: 'History', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', adminOnly: true },
    { label: 'Parking School', view: 'Training', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
    ...
    <>
      <div className="p-8 border-b border-slate-800 flex justify-between items-center">
        <div>
          ...
          <p className="text-[10px] text-slate-400 mt-1 font-bold uppercase tracking-[0.3em]">PARKING SYSTEM</p>
        </div>
